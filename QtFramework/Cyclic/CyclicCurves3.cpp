...
namespace cagd
{
    GLdouble CyclicCurve3::_CalculateNormalizingCoefficient(GLdouble n)
    {
        if(!n)
        {
            return 1.0;
    ...
    CyclicCurve3::CyclicCurve3(GLuint n, GLenum data_usage_flag):LinearCombination3(0.0, TWO_PI, 2 * n + 1, data_usage_flag),
        _n(n),
